...
export default function PortfolioPage() {
  ...
  // --- Data ---
  const experiences = [
    { side: 'right', date: 'Sept 2025 – Present', title: 'ServerOps Intern', company: 'Y3 TECHNOLOGIES, Singapore', description: 'Actively contributing to the company’s AI and automation initiatives. My work involves developing AI- and ML-driven solutions, along with automation scripts, to help build a next-generation product that transforms workflows and drives the future of our technology. I focus on combining operational reliability with intelligent automation to create scalable, impactful systems. ' },
...
const leadershipItems = [
  ...
  // New items:
 {
    icon: (
      <img
        src="https://www.pngkit.com/png/full/371-3717554_ieee-london-women-in-engineering-ieee-wie-logo.png"
        alt="IEEE WIE"
        style={{ width: 70, height: 40 }}
      />
    ),
    title: 'IEEE WIE ILS ’24 – Organizer Award',
    description: 'Awarded for the best publicity organizer during Women in Engineering International Leadership Summit.'
  },
  {
    icon: (
      <img
        src="https://www.kindpng.com/picc/m/355-3557088_yesist-12-logo-ieee-yesist12-hd-png-download.png"
        alt="coordination"
        style={{ width: 150, height: 40 }}
      />
    ),
    title: 'IEEE YESIST12 Pilot Coordinator',
    description:
      'Represented the Innovation Challenge track globally, steering a team of 150+ pilots which included professors, CEOs, founders, and students.'
  },
  {
    icon: (
      <img
        src="https://imgs.search.brave.com/HnTjs-QzQT5nPR9J-WAUSrQLSumXpbXoI6szCxFqF6E/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9lZHUu/aWVlZS5vcmcvaW4t/a3ByaWV0L3dwLWNv/bnRlbnQvdXBsb2Fk/cy9zaXRlcy8xMDEz/LzIwMjQvMDYvSUVF/RS5wbmc"
        alt="volunteer"
        style={{ width: 70, height: 40 }}
      />
    ),
  ...
  },
  {
    icon: (
      <img
        src="https://storage.googleapis.com/creatorspace-public/users%2Fcmf6z6jso04azu301ody3zaux%2FpET0991OEqa9bNs5-ai_geeks_chennai_logo.jpeg"
        alt="community"
  ...
  },
  {
    icon: (
      <img
        src="https://www.bitsnbytes.us.com/wp-content/uploads/2019/12/logo.jpg"
        alt="cybersecurity"
